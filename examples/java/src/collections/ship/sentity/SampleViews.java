...
public class SampleViews {
     ...
     * completely. </p>
     */
    private static class PartBinding extends TupleSerialBinding<Part, Part> {

        /**
         * Construct the binding object.
         */
        private PartBinding(ClassCatalog classCatalog, Class<Part> dataClass) {
         ...
         */
        @Override
        public Part entryToObject(TupleInput keyInput, Part dataInput) {
         ...
         */
        @Override
        public Part objectToData(Part object) {
    ...
    private static class SupplierBinding
            extends TupleSerialBinding<Supplier, Supplier> {

        /**
         * Construct the binding object.
         */
        private SupplierBinding
        (ClassCatalog classCatalog, Class<Supplier> dataClass) {
         ...
         */
        @Override
        public Supplier entryToObject(TupleInput keyInput, Supplier dataInput) {

            String number = keyInput.readString();
            dataInput.setKey(number);
            return dataInput;
        }
         ...
         */
        @Override
        public Supplier objectToData(Supplier object) {
    ...
    private static class ShipmentBinding
            extends TupleSerialBinding<Shipment, Shipment> {

        /**
         * Construct the binding object.
         */
        private ShipmentBinding
        (ClassCatalog classCatalog, Class<Shipment> dataClass) {
         ...
         */
        @Override
        public Shipment entryToObject(TupleInput keyInput, Shipment dataInput) {

            String partNumber = keyInput.readString();
            String supplierNumber = keyInput.readString();
            dataInput.setKey(partNumber, supplierNumber);
            return dataInput;
        }
         ...
         */
        @Override
        public Shipment objectToData(Shipment object) {
