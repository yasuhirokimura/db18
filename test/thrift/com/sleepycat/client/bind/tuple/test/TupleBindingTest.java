...
import com.sleepycat.client.bind.tuple.BigDecimalBinding;
import com.sleepycat.client.bind.tuple.BigIntegerBinding;
import com.sleepycat.client.bind.tuple.BooleanBinding;
import com.sleepycat.client.bind.tuple.ByteBinding;
import com.sleepycat.client.bind.tuple.CharacterBinding;
import com.sleepycat.client.bind.tuple.DoubleBinding;
import com.sleepycat.client.bind.tuple.FloatBinding;
import com.sleepycat.client.bind.tuple.IntegerBinding;
import com.sleepycat.client.bind.tuple.LongBinding;
import com.sleepycat.client.bind.tuple.PackedIntegerBinding;
import com.sleepycat.client.bind.tuple.PackedLongBinding;
import com.sleepycat.client.bind.tuple.ShortBinding;
import com.sleepycat.client.bind.tuple.SortedBigDecimalBinding;
import com.sleepycat.client.bind.tuple.SortedDoubleBinding;
import com.sleepycat.client.bind.tuple.SortedFloatBinding;
import com.sleepycat.client.bind.tuple.SortedPackedIntegerBinding;
import com.sleepycat.client.bind.tuple.SortedPackedLongBinding;
...
import com.sleepycat.client.bind.tuple.TupleInputBinding;
import com.sleepycat.client.bind.tuple.TupleMarshalledBinding;
import com.sleepycat.client.bind.tuple.TupleOutput;
import com.sleepycat.client.bind.tuple.TupleTupleMarshalledBinding;
...
public class TupleBindingTest {
    ...
    private SDatabaseEntry keyBuffer;

    @Before
    public void setUp() {

        buffer = new SDatabaseEntry();
        keyBuffer = new SDatabaseEntry();
    }
