...
public interface DbConstants
{
    ...
    int DB_BACKUP_DEEP_COPY = 0x00000008;
    int DB_BACKUP_FILES = 0x00000010;
    int DB_BACKUP_NO_LOGS = 0x00000020;
    int DB_BACKUP_READ_COUNT = 1;
    int DB_BACKUP_READ_SLEEP = 2;
    int DB_BACKUP_SINGLE_DIR = 0x00000040;
    int DB_BACKUP_SIZE = 3;
    int DB_BACKUP_UPDATE = 0x00000080;
    ...
    int DB_MEM_DATABASE = 1;
    int DB_MEM_DATABASE_LENGTH = 2;
    int DB_MEM_EXTFILE_DATABASE = 3;
    int DB_MEM_LOCK = 4;
    int DB_MEM_LOCKOBJECT = 5;
    int DB_MEM_LOCKER = 6;
    int DB_MEM_LOGID = 7;
    int DB_MEM_REP_SITE = 8;
    int DB_MEM_TRANSACTION = 9;
    int DB_MEM_THREAD = 10;
    ...
    int DB_REPMGR_CONF_DISABLE_POLL = 0x00000002;
    int DB_REPMGR_CONF_DISABLE_SSL = 0x00000004;
    int DB_REPMGR_CONF_ELECTIONS = 0x00000008;
    int DB_REPMGR_CONF_ENABLE_EPOLL = 0x00000010;
    int DB_REPMGR_CONF_FORWARD_WRITES = 0x00000020;
    int DB_REPMGR_CONF_PREFMAS_CLIENT = 0x00000040;
    int DB_REPMGR_CONF_PREFMAS_MASTER = 0x00000080;
    int DB_REPMGR_CONNECTED = 1;
    int DB_REPMGR_DISCONNECTED = 2;
    int DB_REPMGR_NEED_RESPONSE = 0x00000001;
    int DB_REPMGR_ISELECTABLE = 0x01;
    int DB_REPMGR_ISPEER = 0x02;
    int DB_REPMGR_ISVIEW = 0x04;
    int DB_REPMGR_PEER = 0x00000010;
    int DB_REPMGR_SSL_CA_CERT = 1;
    int DB_REPMGR_SSL_CA_DIR = 2;
    int DB_REPMGR_SSL_REPNODE_CERT = 3;
    int DB_REPMGR_SSL_REPNODE_PRIVATE_KEY = 4;
    int DB_REPMGR_SSL_REPNODE_KEY_PASSWD = 5;
    int DB_REPMGR_SSL_VERIFY_DEPTH = 6;
    int DB_REP_ACK_TIMEOUT = 1;
    int DB_REP_ANYWHERE = 0x00000001;
    int DB_REP_CHECKPOINT_DELAY = 2;
    int DB_REP_CLIENT = 0x00000001;
    int DB_REP_CONF_AUTOINIT = 0x00000100;
    int DB_REP_CONF_BULK = 0x00000400;
    int DB_REP_CONF_DELAYCLIENT = 0x00000800;
    int DB_REP_CONF_INMEM = 0x00002000;
    int DB_REP_CONF_LEASE = 0x00004000;
    int DB_REP_CONF_NOWAIT = 0x00008000;
    ...
    int DB_REP_INELECT = -30980;
    int DB_REP_ISPERM = -30979;
    int DB_REP_LEASE_TIMEOUT = 9;
    int DB_REP_MASTER = 0x00000002;
    int DB_REP_NEWSITE = -30975;
    int DB_REP_NOBUFFER = 0x00000002;
    int DB_REP_NOTPERM = -30974;
    ...
    int DB_SYSTEM_MEM_MISSING = -30965;
    int DB_THREAD = 0x00000020;
    int DB_TIMEOUT = -30968;
    ...
    int DB_VERB_REPMGR_SSL_ALL = 0x00000400;
    int DB_VERB_REPMGR_SSL_CONN = 0x00000800;
    int DB_VERB_REPMGR_SSL_IO = 0x00001000;
    int DB_VERB_REP_ELECT = 0x00002000;
    int DB_VERB_REP_LEASE = 0x00004000;
    int DB_VERB_REP_MISC = 0x00008000;
    int DB_VERB_REP_MSGS = 0x00010000;
    int DB_VERB_REP_SYNC = 0x00020000;
    int DB_VERB_REP_SYSTEM = 0x00040000;
    int DB_VERB_REP_TEST = 0x00080000;
    int DB_VERB_SLICE = 0x00100000;
    int DB_VERB_WAITSFOR = 0x00200000;
    int DB_VERIFY = 0x00000004;
    int DB_VERSION_MAJOR = 18;
    int DB_VERSION_MINOR = 1;
    int DB_VERSION_PATCH = 40;
