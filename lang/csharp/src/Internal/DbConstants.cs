...
namespace BerkeleyDB.Internal {
    ...
    internal class DbConstants {
        ...
        internal const uint DB_BACKUP_DEEP_COPY = 0x00000008;
        internal const uint DB_BACKUP_FILES = 0x00000010;
        internal const uint DB_BACKUP_NO_LOGS = 0x00000020;
        internal const uint DB_BACKUP_READ_COUNT = 1;
        internal const uint DB_BACKUP_READ_SLEEP = 2;
        internal const uint DB_BACKUP_SINGLE_DIR = 0x00000040;
        internal const uint DB_BACKUP_SIZE = 3;
        internal const uint DB_BACKUP_UPDATE = 0x00000080;
        ...
        internal const uint DB_EVENT_REP_AUTOTAKEOVER = 3;
        internal const uint DB_EVENT_REP_AUTOTAKEOVER_FAILED = 4;
        internal const uint DB_EVENT_REP_CLIENT = 5;
        internal const uint DB_EVENT_REP_CONNECT_BROKEN = 6;
        internal const uint DB_EVENT_REP_CONNECT_ESTD = 7;
        internal const uint DB_EVENT_REP_CONNECT_TRY_FAILED = 8;
        internal const uint DB_EVENT_REP_DUPMASTER = 9;
        internal const uint DB_EVENT_REP_ELECTED = 10;
        internal const uint DB_EVENT_REP_ELECTION_FAILED = 11;
        internal const uint DB_EVENT_REP_INIT_DONE = 12;
        internal const uint DB_EVENT_REP_INQUEUE_FULL = 13;
        internal const uint DB_EVENT_REP_JOIN_FAILURE = 14;
        internal const uint DB_EVENT_REP_LOCAL_SITE_REMOVED = 15;
        internal const uint DB_EVENT_REP_MASTER = 16;
        internal const uint DB_EVENT_REP_MASTER_FAILURE = 17;
        internal const uint DB_EVENT_REP_NEWMASTER = 18;
        internal const uint DB_EVENT_REP_PERM_FAILED = 19;
        internal const uint DB_EVENT_REP_SITE_ADDED = 20;
        internal const uint DB_EVENT_REP_SITE_REMOVED = 21;
        internal const uint DB_EVENT_REP_STARTUPDONE = 22;
        internal const uint DB_EVENT_WRITE_FAILED = 24;
        ...
        internal const uint DB_MEM_DATABASE = 1;
        internal const uint DB_MEM_DATABASE_LENGTH = 2;
        internal const uint DB_MEM_EXTFILE_DATABASE = 3;
        internal const uint DB_MEM_LOCK = 4;
        internal const uint DB_MEM_LOCKOBJECT = 5;
        internal const uint DB_MEM_LOCKER = 6;
        internal const uint DB_MEM_LOGID = 7;
        internal const uint DB_MEM_REP_SITE = 8;
        internal const uint DB_MEM_TRANSACTION = 9;
        internal const uint DB_MEM_THREAD = 10;
        ...
        internal const uint DB_REPMGR_CONF_DISABLE_POLL = 0x00000002;
        internal const uint DB_REPMGR_CONF_DISABLE_SSL = 0x00000004;
        internal const uint DB_REPMGR_CONF_ELECTIONS = 0x00000008;
        internal const uint DB_REPMGR_CONF_ENABLE_EPOLL = 0x00000010;
        internal const uint DB_REPMGR_CONF_FORWARD_WRITES = 0x00000020;
        internal const uint DB_REPMGR_CONF_PREFMAS_CLIENT = 0x00000040;
        internal const uint DB_REPMGR_CONF_PREFMAS_MASTER = 0x00000080;
        ...
        internal const uint DB_REPMGR_ISELECTABLE = 0x01;
        internal const uint DB_REPMGR_ISPEER = 0x02;
        internal const uint DB_REPMGR_ISVIEW = 0x04;
        internal const uint DB_REPMGR_PEER = 0x00000010;
        internal const uint DB_REPMGR_SSL_CA_CERT = 1;
        internal const uint DB_REPMGR_SSL_CA_DIR = 2;
        internal const uint DB_REPMGR_SSL_REPNODE_CERT = 3;
        internal const uint DB_REPMGR_SSL_REPNODE_PRIVATE_KEY = 4;
        internal const uint DB_REPMGR_SSL_REPNODE_KEY_PASSWD = 5;
        internal const uint DB_REPMGR_SSL_VERIFY_DEPTH = 6;
        ...
        internal const uint DB_REP_CONF_AUTOINIT = 0x00000100;
        internal const uint DB_REP_CONF_BULK = 0x00000400;
        internal const uint DB_REP_CONF_DELAYCLIENT = 0x00000800;
        internal const uint DB_REP_CONF_INMEM = 0x00002000;
        internal const uint DB_REP_CONF_LEASE = 0x00004000;
        internal const uint DB_REP_CONF_NOWAIT = 0x00008000;
        ...
        internal const int DB_REP_INELECT = -30980;
        internal const int DB_REP_ISPERM = -30979;
        internal const int DB_REP_JOIN_FAILURE = -30978;
        internal const int DB_REP_LEASE_EXPIRED = -30977;
        internal const int DB_REP_LEASE_TIMEOUT = 9;
        internal const int DB_REP_LOCKOUT = -30976;
        internal const uint DB_REP_MASTER = 0x00000002;
        internal const int DB_REP_NEWSITE = -30975;
        internal const uint DB_REP_NOBUFFER = 0x00000002;
        internal const int DB_REP_NOTPERM = -30974;
        internal const uint DB_REP_PERMANENT = 0x00000004;
        internal const uint DB_REP_REREQUEST = 0x00000008;
        internal const int DB_REP_UNAVAIL = -30973;
        ...
        internal const int DB_RUNRECOVERY = -30971;
        internal const uint DB_SALVAGE = 0x00000040;
        internal const int DB_SECONDARY_BAD = -30970;
        ...
        internal const int DB_SYSTEM_MEM_MISSING = -30965;
        internal const uint DB_THREAD = 0x00000020;
        internal const int DB_TIMEOUT = -30968;
        ...
        internal const uint DB_VERB_REPMGR_SSL_ALL = 0x00000400;
        internal const uint DB_VERB_REPMGR_SSL_CONN = 0x00000800;
        internal const uint DB_VERB_REPMGR_SSL_IO = 0x00001000;
        internal const uint DB_VERB_REP_ELECT = 0x00002000;
        internal const uint DB_VERB_REP_LEASE = 0x00004000;
        internal const uint DB_VERB_REP_MISC = 0x00008000;
        internal const uint DB_VERB_REP_MSGS = 0x00010000;
        internal const uint DB_VERB_REP_SYNC = 0x00020000;
        internal const uint DB_VERB_REP_SYSTEM = 0x00040000;
        internal const uint DB_VERB_REP_TEST = 0x00080000;
        internal const uint DB_VERB_WAITSFOR = 0x00200000;
        internal const uint DB_VERIFY = 0x00000004;
        internal const int DB_VERIFY_BAD = -30967;
        internal const uint DB_VERSION_FAMILY = 18;
        internal const string DB_VERSION_FAMILY_STR = "18";
        internal const uint DB_VERSION_RELEASE = 1;
        internal const string DB_VERSION_RELEASE_STR = "1";
        internal const uint DB_VERSION_MAJOR = 18;
        internal const string DB_VERSION_MAJOR_STR = "18";
        internal const uint DB_VERSION_MINOR = 1;
        internal const string DB_VERSION_MINOR_STR = "1";
        internal const int DB_VERSION_MISMATCH = -30966;
        internal const uint DB_VERSION_PATCH = 40;
        internal const string DB_VERSION_PATCH_STR = "40";
        internal const string DB_VERSION_STRING = "Berkeley DB 18.1.40: May 29 2020 ";
        internal const string DB_VERSION_FULL_STRING = "Berkeley DB Release 18.1 library version 18.1.40: May 29 2020 ";
