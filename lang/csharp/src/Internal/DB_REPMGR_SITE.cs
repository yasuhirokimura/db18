...
internal class DB_REPMGR_SITE : global::System.IDisposable {
  ...
  internal DB_LSN max_ack_lsn {
    set {
      libdb_csharpPINVOKE.DB_REPMGR_SITE_max_ack_lsn_set(swigCPtr, DB_LSN.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = libdb_csharpPINVOKE.DB_REPMGR_SITE_max_ack_lsn_get(swigCPtr);
      DB_LSN ret = (cPtr == global::System.IntPtr.Zero) ? null : new DB_LSN(cPtr, false);
      return ret;
    } 
  }
