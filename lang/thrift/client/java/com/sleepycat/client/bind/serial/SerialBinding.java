 ...
 * the {@link com.sleepycat.client.persist.evolve Direct Persistence Layer}.</p>
 *
 * @author Mark Hayes
 */
public class SerialBinding<E> extends SerialBase implements EntryBinding<E> {
     ...
     */
    public E entryToObject(SDatabaseEntry entry) {
     ...
     *
     * <p>Note that this method sets the SDatabaseEntry offset property to a
     ...
     */
    public void objectToEntry(E object, SDatabaseEntry entry) {
