 ...
 * instance, which is also a {@link com.sleepycat.client.util.FastOutputStream}
...
public class TupleBase<E> {
     ...
     * com.sleepycat.client.util.FastOutputStream#DEFAULT_INIT_SIZE} size will be
     * used.</p>
     */
    public TupleBase() {
        outputBufferSize = 0;
     ...
     * com.sleepycat.client.util.FastOutputStream#DEFAULT_INIT_SIZE} size is used.</p>
     *
     ...
     * {@link com.sleepycat.client.util.FastOutputStream#reset} method before each
     * use.</p>
     *
     ...
     */
    public static void outputToEntry(TupleOutput output, SDatabaseEntry entry) {
     ...
     * @param entry is the destination entry buffer.
     */
    public static void inputToEntry(TupleInput input, SDatabaseEntry entry) {
     ...
     */
    public static TupleInput entryToInput(SDatabaseEntry entry) {
