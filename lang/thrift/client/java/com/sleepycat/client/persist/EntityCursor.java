...
public interface EntityCursor<V> extends ForwardCursor<V> {
     ...
     * @throws SDatabaseException the base class for all BDB exceptions.
     */
    V nextNoDup(SLockMode lockMode)
        throws SDatabaseException;
     ...
     * @throws SDatabaseException the base class for all BDB exceptions.
     */
    V prevNoDup(SLockMode lockMode)
        throws SDatabaseException;
     ...
     * will inherit this cursor's {@link STransaction} and {@link SCursorConfig}.
     *
