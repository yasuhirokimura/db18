...
public class PersistKeyBinding implements EntryBinding {
    ...
    public Object entryToObject(SDatabaseEntry entry) {
        try {
    ...
    private Object entryToObjectInternal(SDatabaseEntry entry)
        throws RefreshException {
    ...
    private void objectToEntryInternal(Object object, SDatabaseEntry entry)
        throws RefreshException {
