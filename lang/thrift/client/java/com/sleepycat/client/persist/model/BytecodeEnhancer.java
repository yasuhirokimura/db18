...
import static com.sleepycat.client.asm.Opcodes.AALOAD;
import static com.sleepycat.client.asm.Opcodes.ACC_ABSTRACT;
import static com.sleepycat.client.asm.Opcodes.ACC_PRIVATE;
import static com.sleepycat.client.asm.Opcodes.ACC_PUBLIC;
import static com.sleepycat.client.asm.Opcodes.ACC_STATIC;
import static com.sleepycat.client.asm.Opcodes.ACC_TRANSIENT;
import static com.sleepycat.client.asm.Opcodes.ACONST_NULL;
import static com.sleepycat.client.asm.Opcodes.ALOAD;
import static com.sleepycat.client.asm.Opcodes.ANEWARRAY;
import static com.sleepycat.client.asm.Opcodes.ARETURN;
import static com.sleepycat.client.asm.Opcodes.ASM4;
import static com.sleepycat.client.asm.Opcodes.BIPUSH;
import static com.sleepycat.client.asm.Opcodes.CHECKCAST;
import static com.sleepycat.client.asm.Opcodes.DCMPL;
import static com.sleepycat.client.asm.Opcodes.DCONST_0;
import static com.sleepycat.client.asm.Opcodes.DUP;
import static com.sleepycat.client.asm.Opcodes.FCMPL;
import static com.sleepycat.client.asm.Opcodes.FCONST_0;
import static com.sleepycat.client.asm.Opcodes.GETFIELD;
import static com.sleepycat.client.asm.Opcodes.GOTO;
import static com.sleepycat.client.asm.Opcodes.ICONST_0;
import static com.sleepycat.client.asm.Opcodes.ICONST_1;
import static com.sleepycat.client.asm.Opcodes.ICONST_2;
import static com.sleepycat.client.asm.Opcodes.ICONST_3;
import static com.sleepycat.client.asm.Opcodes.ICONST_4;
import static com.sleepycat.client.asm.Opcodes.ICONST_5;
import static com.sleepycat.client.asm.Opcodes.IFEQ;
import static com.sleepycat.client.asm.Opcodes.IFGT;
import static com.sleepycat.client.asm.Opcodes.IFLE;
import static com.sleepycat.client.asm.Opcodes.IFNE;
import static com.sleepycat.client.asm.Opcodes.IFNONNULL;
import static com.sleepycat.client.asm.Opcodes.IF_ICMPNE;
import static com.sleepycat.client.asm.Opcodes.ILOAD;
import static com.sleepycat.client.asm.Opcodes.INVOKEINTERFACE;
import static com.sleepycat.client.asm.Opcodes.INVOKESPECIAL;
import static com.sleepycat.client.asm.Opcodes.INVOKESTATIC;
import static com.sleepycat.client.asm.Opcodes.INVOKEVIRTUAL;
import static com.sleepycat.client.asm.Opcodes.IRETURN;
import static com.sleepycat.client.asm.Opcodes.ISUB;
import static com.sleepycat.client.asm.Opcodes.LCMP;
import static com.sleepycat.client.asm.Opcodes.LCONST_0;
import static com.sleepycat.client.asm.Opcodes.NEW;
import static com.sleepycat.client.asm.Opcodes.POP;
import static com.sleepycat.client.asm.Opcodes.PUTFIELD;
import static com.sleepycat.client.asm.Opcodes.RETURN;
...
import com.sleepycat.client.asm.AnnotationVisitor;
import com.sleepycat.client.asm.Attribute;
import com.sleepycat.client.asm.ClassVisitor;
import com.sleepycat.client.asm.FieldVisitor;
import com.sleepycat.client.asm.Label;
import com.sleepycat.client.asm.MethodVisitor;
import com.sleepycat.client.asm.Type;
 ...
 * resulting enhanced class implements the com.sleepycat.client.persist.impl.Enhanced
 * interface.
 *
