...
public class PrimaryIndex<PK, E> extends BasicIndex<PK, E> {
     ...
     */
    public PrimaryIndex(SDatabase database,
                        Class<PK> keyClass,
     ...
     * @throws SDatabaseException the base class for all BDB exceptions.
     */
    public E put(STransaction txn, E entity)
        throws SDatabaseException {
        ...
        boolean failed = true;
        SCursor cursor = db.openCursor(txn, cursorConfig);
        SLockMode lockMode = locking ? SLockMode.RMW : null;
        try {
            while (true) {
     ...
     * Inserts an entity, or updates it if the primary key already exists (does
     * not return the existing entity).  This method may be used instead of
     * {@link #put(STransaction,Object)} to save the overhead of returning the
     * existing entity.
     *
     * <p>If a {@link PrimaryKey#sequence} is used and the primary key field of
     * the given entity is null or zero, this method will assign the next value
     ...
     * @throws SDatabaseException the base class for all BDB exceptions.
     */
    public void putNoReturn(STransaction txn, E entity)
        throws SDatabaseException {
     ...
     * @throws SDatabaseException the base class for all BDB exceptions.
     */
    public boolean putNoOverwrite(STransaction txn, E entity)
        throws SDatabaseException {
        ...
        SOperationStatus status = db.putNoOverwrite(txn, keyEntry, dataEntry);
     ...
     */
    private void assignKey(E entity, SDatabaseEntry keyEntry)
        throws SDatabaseException {
