...
public class PersistEntityBinding implements EntityBinding {
    ...
    public Object entryToObject(final SDatabaseEntry key,
     ...
     */
    private Object entryToObjectInternal(final SDatabaseEntry key,
                                         final Object priKey,
                                         final SDatabaseEntry data)
    ...
    public void objectToData(final Object entity, final SDatabaseEntry data) {
        try {
    ...
    public void objectToKey(final Object entity, final SDatabaseEntry key) {
        try {
