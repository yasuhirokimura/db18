...
/**
 * A List view of a {@link SDatabase}.
 *
 * <p>For all stored lists the keys of the underlying SDatabase
...
public class StoredList<E> extends StoredCollection<E> implements List<E> {
    ...
    /**
     * Creates a list view of a {@link SDatabase}.
     *
     ...
     * If a {@link com.sleepycat.client.collections.PrimaryKeyAssigner} is associated
     ...
     * com.sleepycat.client.collections.PrimaryKeyAssigner} and is not a QUEUE or
     * RECNO database.
     *
     * @throws RuntimeExceptionWrapper if a checked exception is thrown,
     * including a {@code DatabaseException} on BDB (C Edition).
    ...
    private int indexOf(Object value, boolean findFirst) {
        ...
        try {
            ...
            SOperationStatus status = cursor.findValue(value, findFirst);
