...
/**
 * A SortedMap view of a {@link SDatabase}.
 *
...
public class StoredSortedMap<K, V>
    ...
    /**
     * Creates a sorted map view of a {@link SDatabase}.
     *
     ...
     */
    public StoredSortedMap(SDatabase database,
    ...
    /**
     * Creates a sorted map view of a {@link SDatabase} with a {@link
    ...
    /**
     * Creates a sorted map entity view of a {@link SDatabase}.
     *
     * @param database is the SDatabase underlying the new collection.
     *
     * @param keyBinding is the binding used to translate between key buffers
    ...
    /**
     * Creates a sorted map entity view of a {@link SDatabase} with a {@link
     * PrimaryKeyAssigner}.  Writing is allowed for the created map.
     *
     * @param database is the SDatabase underlying the new collection.
     *
    ...
    private K getFirstOrLastKey(boolean doGetFirst) {
        ...
        try {
            ...
            return (K) ((status == SOperationStatus.SUCCESS) ?
