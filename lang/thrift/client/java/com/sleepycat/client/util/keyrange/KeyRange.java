...
public class KeyRange {
     ...
     */
    public KeyRange subRange(SDatabaseEntry key)
     ...
     * range parameters.
     */
    public KeyRange subRange(SDatabaseEntry beginKey, boolean beginInclusive,
                             SDatabaseEntry endKey, boolean endInclusive)
        throws KeyRangeException {
     ...
     */
    public boolean check(SDatabaseEntry key) {
     ...
     * Returns whether a given key is within range.
     */
    public boolean check(SDatabaseEntry key, boolean inclusive) {
     ...
     * conservatively.</p>
     */
    public boolean checkBegin(SDatabaseEntry key, boolean inclusive) {
     ...
     */
    public boolean checkEnd(SDatabaseEntry key, boolean inclusive) {
     ...
     */
    public int compare(SDatabaseEntry key1, SDatabaseEntry key2) {
     ...
     */
    public static SDatabaseEntry copy(SDatabaseEntry from) {
        return new SDatabaseEntry(getByteArray(from));
    }
     ...
     * non-zero.
     */
    public static byte[] getByteArray(SDatabaseEntry entry) {
        return getByteArrayInternal(entry, Integer.MAX_VALUE);
    }

    public static byte[] getByteArray(SDatabaseEntry entry, int maxBytes) {
        return getByteArrayInternal(entry, maxBytes);
    }

    private static byte[] getByteArrayInternal(SDatabaseEntry entry,
                                               int maxBytes) {
    ...
    /**
     * Returns the two SDatabaseEntry objects have the same data value.
     */
    public static boolean equalBytes(SDatabaseEntry e1, SDatabaseEntry e2) {
     ...
     */
    public static String toString(SDatabaseEntry dbt) {
