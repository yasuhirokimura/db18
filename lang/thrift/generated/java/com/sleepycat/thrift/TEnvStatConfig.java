...
public class TEnvStatConfig implements org.apache.thrift.TBase<TEnvStatConfig, TEnvStatConfig._Fields>, java.io.Serializable, Cloneable, Comparable<TEnvStatConfig> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TEnvStatConfigStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TEnvStatConfigTupleSchemeFactory();
  ...
  public int hashCode() {
    ...
    if (isSetCache())
      hashCode = hashCode * 8191 + cache.getValue();

    hashCode = hashCode * 8191 + ((isSetCacheFile()) ? 131071 : 524287);
    if (isSetCacheFile())
      hashCode = hashCode * 8191 + cacheFile.getValue();

    hashCode = hashCode * 8191 + ((isSetLock()) ? 131071 : 524287);
    if (isSetLock())
      hashCode = hashCode * 8191 + lock.getValue();

    hashCode = hashCode * 8191 + ((isSetLog()) ? 131071 : 524287);
    if (isSetLog())
      hashCode = hashCode * 8191 + log.getValue();

    hashCode = hashCode * 8191 + ((isSetMutex()) ? 131071 : 524287);
    if (isSetMutex())
      hashCode = hashCode * 8191 + mutex.getValue();

    hashCode = hashCode * 8191 + ((isSetTransaction()) ? 131071 : 524287);
    if (isSetTransaction())
      hashCode = hashCode * 8191 + transaction.getValue();
  ...
  public int compareTo(TEnvStatConfig other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCacheFile()).compareTo(other.isSetCacheFile());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCacheFile()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMutex()).compareTo(other.isSetMutex());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMutex()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TEnvStatConfig(");
    boolean first = true;
  ...
  private static class TEnvStatConfigStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TEnvStatConfigStandardScheme getScheme() {
      return new TEnvStatConfigStandardScheme();
    }
  }

  private static class TEnvStatConfigStandardScheme extends org.apache.thrift.scheme.StandardScheme<TEnvStatConfig> {
  ...
  private static class TEnvStatConfigTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TEnvStatConfigTupleScheme getScheme() {
      return new TEnvStatConfigTupleScheme();
    }
  }

  private static class TEnvStatConfigTupleScheme extends org.apache.thrift.scheme.TupleScheme<TEnvStatConfig> {
