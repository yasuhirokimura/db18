...
public class TEnvStatResult implements org.apache.thrift.TBase<TEnvStatResult, TEnvStatResult._Fields>, java.io.Serializable, Cloneable, Comparable<TEnvStatResult> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TEnvStatResultStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TEnvStatResultTupleSchemeFactory();

  public TCacheStat cacheStat; // optional
  public java.util.List<TCacheFileStat> cacheFileStat; // optional
  ...
  public TEnvStatResult(TEnvStatResult other) {
    ...
    if (other.isSetCacheFileStat()) {
      java.util.List<TCacheFileStat> __this__cacheFileStat = new java.util.ArrayList<TCacheFileStat>(other.cacheFileStat.size());
  ...
  public void addToCacheFileStat(TCacheFileStat elem) {
    if (this.cacheFileStat == null) {
      this.cacheFileStat = new java.util.ArrayList<TCacheFileStat>();
    }
    this.cacheFileStat.add(elem);
  }

  public java.util.List<TCacheFileStat> getCacheFileStat() {
    return this.cacheFileStat;
  }

  public TEnvStatResult setCacheFileStat(java.util.List<TCacheFileStat> cacheFileStat) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case CACHE_FILE_STAT:
      if (value == null) {
        ...
        setCacheFileStat((java.util.List<TCacheFileStat>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetCacheStat()) ? 131071 : 524287);
    if (isSetCacheStat())
      hashCode = hashCode * 8191 + cacheStat.hashCode();

    hashCode = hashCode * 8191 + ((isSetCacheFileStat()) ? 131071 : 524287);
    if (isSetCacheFileStat())
      hashCode = hashCode * 8191 + cacheFileStat.hashCode();

    hashCode = hashCode * 8191 + ((isSetLockStat()) ? 131071 : 524287);
    if (isSetLockStat())
      hashCode = hashCode * 8191 + lockStat.hashCode();

    hashCode = hashCode * 8191 + ((isSetLogStat()) ? 131071 : 524287);
    if (isSetLogStat())
      hashCode = hashCode * 8191 + logStat.hashCode();

    hashCode = hashCode * 8191 + ((isSetMutexStat()) ? 131071 : 524287);
    if (isSetMutexStat())
      hashCode = hashCode * 8191 + mutexStat.hashCode();

    hashCode = hashCode * 8191 + ((isSetTxnStat()) ? 131071 : 524287);
    if (isSetTxnStat())
      hashCode = hashCode * 8191 + txnStat.hashCode();
  ...
  public int compareTo(TEnvStatResult other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCacheStat()).compareTo(other.isSetCacheStat());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCacheFileStat()).compareTo(other.isSetCacheFileStat());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCacheFileStat()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetLockStat()).compareTo(other.isSetLockStat());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLockStat()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetLogStat()).compareTo(other.isSetLogStat());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLogStat()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMutexStat()).compareTo(other.isSetMutexStat());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMutexStat()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTxnStat()).compareTo(other.isSetTxnStat());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTxnStat()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TEnvStatResult(");
    boolean first = true;
  ...
  private static class TEnvStatResultStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TEnvStatResultStandardScheme getScheme() {
      return new TEnvStatResultStandardScheme();
    }
  }

  private static class TEnvStatResultStandardScheme extends org.apache.thrift.scheme.StandardScheme<TEnvStatResult> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cacheFileStat = new java.util.ArrayList<TCacheFileStat>(_list34.size);
  ...
  private static class TEnvStatResultTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TEnvStatResultTupleScheme getScheme() {
      return new TEnvStatResultTupleScheme();
    }
  }

  private static class TEnvStatResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<TEnvStatResult> {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.cacheFileStat = new java.util.ArrayList<TCacheFileStat>(_list39.size);
